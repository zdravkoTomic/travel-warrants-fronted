            ...
            >
                {({touched, errors}) => (
                    <Form>
                        ...
                        <div className="row">
                            <div className="mx-auto col-10 col-md-8 col-lg-6 mb-3">
                                <label className="form-label" htmlFor="codeNumeric">Službeni međunarodni brojčani kod
                                    valute:</label>
                                <Field id="floatingInput" className="form-control" type="text" name="codeNumeric"/>
